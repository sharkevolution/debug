...
router.register('roomcreate', views.CreateRoomUser)
...
urlpatterns += [
    ...
    path('rooms/<int:pk>/', views.RoomsAPIDetailView.as_view(), name='rooms_api_detail'),
    ...
    path('users/<int:pk>/', views.UserAPIDetailView.as_view(), name='users_api_detail'),  # Детально
